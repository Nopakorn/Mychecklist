...
public abstract class BaseActivity extends Activity{
    ...
    protected void checked(){
        ...
        dbconn = new DbConnected();
        dbconn.update_status_dbc(mCheck.getIndexCurrentCheck()+1);
    ...
    //contextual voice command handle*
    @Override
        ...
        if (featureId == WindowUtils.FEATURE_VOICE_COMMANDS) {
            switch (item.getItemId()) {
                case R.id.save_menu_item:
                    handleGameGesture(Gesture.TAP);
                    break;
                case R.id.next_menu_item:
                    handleGameGesture(Gesture.SWIPE_RIGHT);
                    break;
                case R.id.exit_menu_item:
                    handleGameGesture(Gesture.SWIPE_DOWN);
                    break;
                default:
                    return true;
            }
